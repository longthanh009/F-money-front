          ...
          <table className="table-auto w-full">
            ...
            <tbody className="text-sm font-medium divide-y divide-slate-100">
              ...
              <tr>
                ...
                <td className="p-2">
                  <div className="text-center text-blue-800">+2.000.000</div>
                </td>
                <td className="p-2">
                ...
                <td className="p-2 md:flex">
                  ...
                  <span className="absolute top-0 hidden -mt-8 text-xs font-bold group-hover:block">In Phiếu</span>
                    <BiPrinter />
                  </div>
                  <div className="items-center text-gray-500 pl-5 relative group">
                  <span className="absolute top-0 hidden -mt-6 text-xs font-bold group-hover:block">Xóa</span>
