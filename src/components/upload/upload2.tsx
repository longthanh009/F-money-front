...
const ImageUpload2 = (props: Props) => {
  ...
  const uploadButton = (
    <div>
      <PlusOutlined />
      <div style={{ margin: 8 }}>Upload <br /> (Mặt sau)</div>
    </div >
  )
  ...
  return (<>
    <Form.Item name='avatarList2' style={{ display: "flex", alignItems: "start", justifyContent: 'start' }}   >
