...
const Solution = () => {
    return (
        <div className='Solution text-center'>
            ...
            <div className="flex flex-col p-12">
                ...
                <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                    <div data-aos="fade-up"
                        data-aos-duration="800" className="bg-white p-4 shadow-lg flex flex-col items-center text-center group md:lg:xl:border-r md:lg:xl:border-b hover:scale-105">
                    ...
                    <div data-aos="fade-up"
                        data-aos-duration="1200" className="bg-white p-4 shadow-lg flex flex-col items-center text-center group md:lg:xl:border-r md:lg:xl:border-b hover:scale-105">
                        <span className="p-5 rounded-full bg-orange-500 text-white shadow-lg shadow-red-200">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                    ...
                    <div data-aos="fade-up"
                        data-aos-duration="1600" className="bg-white p-4 shadow-lg flex flex-col items-center text-center group md:lg:xl:border-r md:lg:xl:border-b hover:scale-105">
                        <span className="p-5 rounded-full bg-orange-500 text-white shadow-lg shadow-red-200">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                    ...
                    <div data-aos="fade-up"
                        data-aos-duration="2000" className="bg-white p-4 shadow-lg flex flex-col items-center text-center group md:lg:xl:border-r md:lg:xl:border-b hover:scale-105">
                        <span className="p-5 rounded-full bg-orange-500 text-white shadow-lg shadow-red-200">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
            ...
            {/**Banner */}
            <div>
                <img src="https://smartnetvn.com.vn/smn_website/static/src/img/banner_vay_tien_mat.png" alt="" />
            </div>
            {/**Cho vay tiền mặt */}
            <div className="flex flex-col p-12 ">
                <div className='text-center'>
                    <h2 className="mb-4 text-3xl font-bold text-orange-600">CHO VAY TIỀN MẶT</h2>
                </div>
                <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
                    <div className=" p-4 shadow-lg flex flex-col items-center text-center group md:lg:xl:border-r md:lg:xl:border-b">
                        <img src="https://www.vaytiennongnhanhtphcm.com/wp-content/uploads/2021/10/tu-kinh-doanh.jpg" alt="" />
                    ...
                    <div className=" p-4 shadow-lg flex flex-col items-center text-center group md:lg:xl:border-r md:lg:xl:border-b">
                        <img src="https://www.vaytiennongnhanhtphcm.com/wp-content/uploads/2021/10/huong-luong.jpg" alt="" />
                    ...
                    <div className=" p-4 shadow-lg flex flex-col items-center text-center group md:lg:xl:border-r md:lg:xl:border-b">
                        <img src="https://www.vaytiennongnhanhtphcm.com/wp-content/uploads/2021/10/lam-nghe-tu-do.jpg" alt="" />
                        ...
                        <p className='p-4'>Quý khách hàng là doanh nghiệp vừa và nhỏ, đôi khi cần tiền gấp mà không biết “xoay” đâu. <br />
                            Vậy thì chờ gì mà không đăng ký <br />
                            tìm hiểu ngay các sản phẩm vay với nhiều loại giấy tờ linh động!</p>
                    </div>
                </div>
            </div>
        </div>
