...
import './Unsecured.css'
import { Button, Modal } from 'antd';


type Props = {}

const Unsecured = (props: Props) => {
            ...
            <table style={{border: 'none'}} className="table  tablecustomize">
              <thead className="m-datatable__head">
                <tr className="m-datatable__row">
                  ...
                  <th className="m-datatable__cell--center  m-datatable__cell m-datatable__cell--sort"><span style={{width: '80px'}}>Khách hàng</span></th>
                  <th className="m-datatable__cell--center  m-datatable__cell m-datatable__cell--sort"><span style={{width: '80px'}}>Tiền giao khách</span></th>
                  <th className="m-datatable__cell--center  m-datatable__cell m-datatable__cell--sort"><span style={{width: '80px'}}>Tỷ lệ</span></th>
                  <th className="m-datatable__cell--center  m-datatable__cell m-datatable__cell--sort"><span style={{width: '80px'}}>Thời gian</span></th>
                  <th className="m-datatable__cell--center  m-datatable__cell m-datatable__cell--sort"><span style={{width: '80px'}}>Tiền đã đóng</span></th>
                  <th className="m-datatable__cell--center  m-datatable__cell m-datatable__cell--sort"><span style={{width: '80px'}}>Nợ cũ</span></th>
                  <th className="m-datatable__cell--center  m-datatable__cell m-datatable__cell--sort"><span style={{width: '80px'}}>Tiền 1 ngày</span></th>
                  <th className="m-datatable__cell--center  m-datatable__cell m-datatable__cell--sort"><span style={{width: '80px'}}>Còn phải đóng</span></th>
              ...
              <tr className="m-datatable__row">
                  ...
                  <td style={{ textAlign: 'center'}} className="m-datatable__cell--center  m-datatable__cell m-datatable__cell--sort"><span style={{width: '80px', color: '#00aaff', fontSize: '14px'}}>phan Văn Mạnh</span></td>
                  ...
                  <td className="m-datatable__cell--center  m-datatable__cell m-datatable__cell--sort"><span style={{width: '80px'}}>1.300.000 đ</span></td>
                  <td className="m-datatable__cell--center  m-datatable__cell m-datatable__cell--sort"><span style={{width: '80px'}}></span></td>
                  <td className="m-datatable__cell--center  m-datatable__cell m-datatable__cell--sort"><span style={{width: '80px'}}>600.000 đ</span></td>
                  <td className="m-datatable__cell--center  m-datatable__cell m-datatable__cell--sort"><span style={{width: '80px', color: 'red'}}>10.800.000 đ</span></td>
